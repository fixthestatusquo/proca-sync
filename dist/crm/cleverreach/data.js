...
const formatAction = (message, hasValues, customLabel) => {
    ...
    const global = {
        ...
        zip: ((_b = message.contact) === null || _b === void 0 ? void 0 : _b.postcode)
            ? (_c = message.contact) === null || _c === void 0 ? void 0 : _c.postcode.toString()
            : (hasValues === null || hasValues === void 0 ? void 0 : hasValues.zip) || "",
        lastname: (hasValues === null || hasValues === void 0 ? void 0 : hasValues.lastname) && !message.contact.lastName
            ? hasValues.lastname
            : message.contact.lastName || "",
        firstname: message.contact.firstName,
        country: message.contact.country || message.contact.area || "",
        company: (hasValues === null || hasValues === void 0 ? void 0 : hasValues.company) && !message.contact.company
            ? hasValues.company
            : ((_e = (_d = message.action.customFields) === null || _d === void 0 ? void 0 : _d.organisation) === null || _e === void 0 ? void 0 : _e.toString()) || "",
